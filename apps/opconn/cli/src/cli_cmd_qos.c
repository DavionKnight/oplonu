...
STATUS cliCmdQoSShowClassRule(ENV_t *pstEnv, PARA_TABLE_t *pstPt)
{
    ...
    cliShowStart(pstEnv);
    ret = dalClsRuleEntryShow(pstEnv->nWriteFd,0,127,(pstPt[0].i -1));
    cliShowEnd(pstEnv);
...
STATUS cliCmdQoSShowClassMask(ENV_t *pstEnv, PARA_TABLE_t *pstPt)
{
    ...
    cliShowStart(pstEnv);
    ret = dalClsMaskEntryShow(pstEnv->nWriteFd,0,23,(pstPt[0].i -1));
    cliShowEnd(pstEnv);
...
STATUS cliCmdQoSShowClassAddr(ENV_t *pstEnv, PARA_TABLE_t *pstPt)
{
    ...
    ret = dalClsAddrEntryShow(pstEnv->nWriteFd,0,127,(pstPt[0].i -1));
...
STATUS cliCmdQoSShowCfg(ENV_t *pstEnv, PARA_TABLE_t *pstPt)
{
    ...
    cliShowStart(pstEnv);
    ret = dalClsCfgShow(pstEnv->nWriteFd,1,128);
    cliShowEnd(pstEnv);
