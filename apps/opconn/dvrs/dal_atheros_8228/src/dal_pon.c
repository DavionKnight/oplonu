...
OPL_STATUS dalOnuMtuSet(UINT32 mtuSize)
{
    ...
    ret += shiva_frame_max_size_set(0,mtuSize);
	return ret;
}
...
{
	return shiva_frame_max_size_get(0,mtuSize);
