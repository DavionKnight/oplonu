...
/******************************************************************************
*
* f1_phy_get_power - test to see if the phy power is on
*
* RETURNS:
*    A_TRUE  --> power is on
...
*/
a_bool_t
f1_phy_get_power(a_uint32_t dev_id, a_uint32_t phy_id)
{
    a_uint16_t phy_data;

    phy_data = f1_phy_reg_read(dev_id, phy_id, F1_PHY_CONTROL);

    if (!(phy_data & F1_CTRL_POWER_DOWN))
        return A_TRUE;
...
sw_error_t
f1_phy_disable_autoneg(a_uint32_t dev_id, a_uint32_t phy_id)
{
    a_uint16_t phy_data = 0;
...
/******************************************************************************
*
* f1_phy_set_lpbk - Determines the loopback of phy ports associated with the
* specified device.
*
* RETURNS:
*               SW_OK;
*/
sw_error_t
f1_phy_set_lpbk(a_uint32_t dev_id, a_uint32_t phy_id,
                     a_uint8_t enable)
{
	a_uint16_t phy_data = 0;
...
/******************************************************************************
*
* f1_phy_get_lpbk - get  the loopback of phy ports associated with the
* specified device.
*
* RETURNS:
*              1 or 0;
*/
sw_error_t
f1_phy_get_lpbk(a_uint32_t dev_id, a_uint32_t phy_id,
                     a_uint8_t *enable)
{
	a_uint16_t phy_data = 0;
