                   ...
                   a_uint32_t reg[])
{
	...
	#if 0
		if (A_FALSE ==hsl_mports_prop_check(dev_id, entry->port.map, HSL_PP_INCL_CPU)) 
		{
			return SW_BAD_PARAM;
		}
	#endif
...
/* ARL Address Table0 Register */
#define RESV_ADDR_TBL0
#define RESV_ADDR_TBL0_OFFSET    0x30000
#define FDB_ADDR_TBL0_E_LENGTH  4
#define FDB_ADDR_TBL0_E_OFFSET  0
#define FDB_ADDR_TBL0_NR_E      1

#define FDB_ADDR_BYTE2
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE2_BOFFSET 24
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE2_BLEN    8
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE2_FLAG    HSL_RW

#define FDB_ADDR_BYTE3
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE3_BOFFSET 16
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE3_BLEN    8
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE3_FLAG    HSL_RW

#define FDB_ADDR_BYTE4
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE4_BOFFSET 8
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE4_BLEN    8
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE4_FLAG    HSL_RW

#define FDB_ADDR_BYTE5
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE5_BOFFSET 0
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE5_BLEN    8
#define FDB_ADDR_TBL0_FDB_ADDR_BYTE5_FLAG    HSL_RW

/* Reserve Address Table1 Register */
#define FDB_ADDR_TBL1
#define FDB_ADDR_TBL1_OFFSET    0x30004
#define FDB_ADDR_TBL1_E_LENGTH  4
#define FDB_ADDR_TBL1_E_OFFSET  0
#define FDB_ADDR_TBL1_NR_E      1

#define FDB_SA_DROP_EN
#define FDB_ADDR_TBL1_FDB_SA_DROP_EN_BOFFSET 30
#define FDB_ADDR_TBL1_FDB_SA_DROP_EN_BLEN    1
#define FDB_ADDR_TBL1_FDB_SA_DROP_EN_FLAG    HSL_RW

#define FDB_MIRROR_EN
#define FDB_ADDR_TBL1_FDB_MIRROR_EN_BOFFSET     29
#define FDB_ADDR_TBL1_FDB_MIRROR_EN_BLEN        1
#define FDB_ADDR_TBL1_FDB_MIRROR_EN_FLAG        HSL_RW

#define FDB_PRI_EN
#define FDB_ADDR_TBL1_FDB_PRI_EN_BOFFSET     28
#define FDB_ADDR_TBL1_FDB_PRI_EN_BLEN        1
#define FDB_ADDR_TBL1_FDB_PRI_EN_FLAG        HSL_RW

#define FDB_SVL_EN
#define FDB_ADDR_TBL1_FDB_SVL_EN_BOFFSET     27
#define FDB_ADDR_TBL1_FDB_SVL_EN_BLEN        1
#define FDB_ADDR_TBL1_FDB_SVL_EN_FLAG        HSL_RW

#define FDB_PRI
#define FDB_ADDR_TBL1_FDB_PRI_BOFFSET        24
#define FDB_ADDR_TBL1_FDB_PRI_BLEN           3
#define FDB_ADDR_TBL1_FDB_PRI_FLAG           HSL_RW

#define FDB_CROSS_PT
#define FDB_ADDR_TBL1_FDB_CROSS_PT_BOFFSET      23
#define FDB_ADDR_TBL1_FDB_CROSS_PT_BLEN         1
#define FDB_ADDR_TBL1_FDB_CROSS_PT_FLAG         HSL_RW

#define FDB_DES_PORT
#define FDB_ADDR_TBL1_FDB_DES_PORT_BOFFSET      16
#define FDB_ADDR_TBL1_FDB_DES_PORT_BLEN         7
#define FDB_ADDR_TBL1_FDB_DES_PORT_FLAG         HSL_RW

#define FDB_ADDR_BYTE0
#define FDB_ADDR_TBL1_FDB_ADDR_BYTE0_BOFFSET 8
#define FDB_ADDR_TBL1_FDB_ADDR_BYTE0_BLEN    8
#define FDB_ADDR_TBL1_FDB_ADDR_BYTE0_FLAG    HSL_RW

#define FDB_ADDR_BYTE1
#define FDB_ADDR_TBL1_FDB_ADDR_BYTE1_BOFFSET 0
#define FDB_ADDR_TBL1_FDB_ADDR_BYTE1_BLEN    8
#define FDB_ADDR_TBL1_FDB_ADDR_BYTE1_FLAG    HSL_RW

/* Reserve Address Table2 Register */
#define FDB_ADDR_TBL2
#define FDB_ADDR_TBL2_OFFSET    0x30008
#define FDB_ADDR_TBL2_E_LENGTH  4
#define FDB_ADDR_TBL2_E_OFFSET  0
#define FDB_ADDR_TBL2_NR_E      1

#define FDB_VID
#define FDB_ADDR_TBL2_FDB_VID_BOFFSET   8
#define FDB_ADDR_TBL2_FDB_VID_BLEN      12
#define FDB_ADDR_TBL2_FDB_VID_FLAG      HSL_RW

#define FDB_COPY_TO_CPU
#define FDB_ADDR_TBL2_FDB_COPY_TO_CPU_BOFFSET   7
#define FDB_ADDR_TBL2_FDB_COPY_TO_CPU_BLEN      1
#define FDB_ADDR_TBL2_FDB_COPY_TO_CPU_FLAG      HSL_RW

#define FDB_REDRCT_TO_CPU
#define FDB_ADDR_TBL2_FDB_REDRCT_TO_CPU_BOFFSET 6
#define FDB_ADDR_TBL2_FDB_REDRCT_TO_CPU_BLEN    1
#define FDB_ADDR_TBL2_FDB_REDRCT_TO_CPU_FLAG    HSL_RW

#define FDB_LEAKY_EN
#define FDB_ADDR_TBL2_FDB_LEAKY_EN_BOFFSET      5
#define FDB_ADDR_TBL2_FDB_LEAKY_EN_BLEN         1
#define FDB_ADDR_TBL2_FDB_LEAKY_EN_FLAG         HSL_RW

#define FDB_STATUS
#define FDB_ADDR_TBL2_FDB_STATUS_BOFFSET     0
#define FDB_ADDR_TBL2_FDB_STATUS_BLEN        4
#define FDB_ADDR_TBL2_FDB_STATUS_FLAG        HSL_RW


#define ISIS_FDB_ADDR_NUM  2048
#define FDB_ADDR_TBL0_ADDR 0x30000
#define FDB_ADDR_TBL1_ADDR 0x30004
#define FDB_ADDR_TBL2_ADDR 0x30008
#define FDB_ADDR_TBL3_ADDR 0x3000c

static void
_isis_fdb_atu_hw_to_sw(const a_uint32_t reg[], fal_fdb_entry_t * entry)
{
    a_uint32_t data;
    ...
    entry->fid = FAL_SVL_FID;
	SW_GET_FIELD_BY_REG(FDB_ADDR_TBL2, FDB_VID, data, reg[2]);
	entry->fid = data;

    entry->dacmd = FAL_MAC_FRWRD;
    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL2, FDB_COPY_TO_CPU, data, reg[2]);
    if (1 == data) {
        entry->dacmd = FAL_MAC_CPY_TO_CPU;
    }

    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL2, FDB_REDRCT_TO_CPU, data, reg[2]);
    if (1 == data) {
        entry->dacmd = FAL_MAC_RDT_TO_CPU;
    }
    ...
    entry->leaky_en = A_FALSE;
    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL2, FDB_LEAKY_EN, data, reg[2]);
    if (1 == data) {
        entry->leaky_en = A_TRUE;
    }
    ...
    entry->mirror_en = A_FALSE;
    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL1, FDB_MIRROR_EN, data, reg[1]);
    if (1 == data) {
        entry->mirror_en = A_TRUE;
    }

    entry->da_pri_en = A_FALSE;
    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL1, FDB_PRI_EN, data, reg[1]);
    if (1 == data) {
        SW_GET_FIELD_BY_REG(FDB_ADDR_TBL1, FDB_PRI, data, reg[1]);
        entry->da_pri_en = A_TRUE;
        entry->da_queue = data & 0x7;
    }

    entry->cross_pt_state = A_FALSE;
    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL1, FDB_CROSS_PT, data, reg[1]);
    if (1 == data) {
        entry->cross_pt_state = A_TRUE;
    }

    SW_GET_FIELD_BY_REG(FDB_ADDR_TBL1, FDB_DES_PORT, data, reg[1]);
    entry->portmap_en = A_TRUE;
    entry->port.map = data;
...
static sw_error_t
_isis_fdb_iterate(a_uint32_t dev_id, a_uint32_t * iterator,
                       fal_fdb_entry_t * entry)
{
    a_uint32_t index, addr, data, tbl[4] = { 0 };
    sw_error_t rv;
    ...
    if (ISIS_FDB_ADDR_NUM < *iterator) {
        return SW_BAD_PARAM;
    }

    for (index = *iterator; index < ISIS_FDB_ADDR_NUM; index++) {
        addr = FDB_ADDR_TBL2_ADDR + (index << 4);
        HSL_REG_ENTRY_GEN_GET(rv, dev_id, addr, sizeof (a_uint32_t),
                              (a_uint8_t *) (&(tbl[2])), sizeof (a_uint32_t));
        SW_RTN_ON_ERROR(rv);

        SW_GET_FIELD_BY_REG(FDB_ADDR_TBL2, FDB_STATUS, data, tbl[2]);
        if (data) {
            addr = FDB_ADDR_TBL0_ADDR + (index << 4);
            HSL_REG_ENTRY_GEN_GET(rv, dev_id, addr, sizeof (a_uint32_t),
                                  (a_uint8_t *) (&(tbl[0])),
                                  sizeof (a_uint32_t));
            SW_RTN_ON_ERROR(rv);

            addr = FDB_ADDR_TBL1_ADDR + (index << 4);
            HSL_REG_ENTRY_GEN_GET(rv, dev_id, addr, sizeof (a_uint32_t),
                                  (a_uint8_t *) (&(tbl[1])),
                                  sizeof (a_uint32_t));
            SW_RTN_ON_ERROR(rv);

            _isis_fdb_atu_hw_to_sw(tbl, entry);

			entry->static_en = (data==0xF);
			
            break;
        }
    }

    if (ISIS_FDB_ADDR_NUM == index) {
        return SW_NO_MORE;
    }
...
HSL_LOCAL sw_error_t
isis_fdb_iterate(a_uint32_t dev_id, a_uint32_t * iterator, fal_fdb_entry_t * entry)
{
	sw_error_t rv;

    HSL_API_LOCK;
    rv = _isis_fdb_iterate(dev_id, iterator, entry);
    HSL_API_UNLOCK;
    return rv;
}
...
*/
	...
	option.port_en = A_FALSE;
	option.fid_en = A_FALSE;
	option.multicast_en = A_FALSE;

	//entry->portmap_en = A_TRUE;

	if(*iterator == 0)
	{
		status = isis_fdb_extend_first(0, &option, entry);
	...
	{
		status = isis_fdb_extend_next(0, &option, entry);
		
		if((status != SW_OK) && (status != SW_NO_MORE))
		{		
			return status;
		}
	}
