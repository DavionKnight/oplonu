...
#define SW_API_SWITCH_VERSION      (2  + SW_API_INIT_OFFSET)
...
#define SW_API_COSMAP_UP_QU_SET       (12  + SW_API_QOS_OFFSET)
#define SW_API_COSMAP_UP_QU_GET       (13  + SW_API_QOS_OFFSET)
#define SW_API_COSMAP_DSCP_QU_SET     (14  + SW_API_QOS_OFFSET)
#define SW_API_COSMAP_DSCP_QU_GET     (15  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PT_MODE_SET        (16  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PT_MODE_GET        (17  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PT_MODE_PRI_SET    (18  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PT_MODE_PRI_GET    (19  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PORT_DEF_UP_SET    (20  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PORT_DEF_UP_GET    (21  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PORT_SCH_MODE_SET  (22  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PORT_SCH_MODE_GET  (23  + SW_API_QOS_OFFSET)
