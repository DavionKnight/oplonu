...
typedef struct PHY_STATUS_INFO_s
{
	a_uint8_t		autonegotiation; /*0:disable; 1:enable*/
	a_uint8_t		speed;	/*0:10M; 1:100M; 2: 1000M */
	a_uint8_t		duplex; /*0:half; 1: full */
	a_uint8_t		loopback;	/*0:disable; 1: enable */
}PHY_STATUS_INFO_t;
