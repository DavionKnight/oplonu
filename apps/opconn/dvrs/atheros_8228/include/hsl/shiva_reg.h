...
#define GLB_LOOP_CHECK                            "gint_glblpcheck"
#define GLOBAL_INT_GLB_LOOP_CHECK_BOFFSET         18
#define GLOBAL_INT_GLB_LOOP_CHECK_BLEN            1
#define GLOBAL_INT_GLB_LOOP_CHECK_FLAG            HSL_RW
