...
static inline sw_error_t
_shiva_rate_add_byte_set(a_uint32_t dev_id, fal_port_t port_id,
                         a_uint32_t size)
{
    sw_error_t rv;
    a_uint32_t val;
    ...
    HSL_REG_FIELD_SET(rv, dev_id, RATE_LIMIT0, port_id, ADD_RATE_BYTE,
                          (a_uint8_t *) (&size), sizeof (a_uint32_t));
 ...
 */
HSL_LOCAL sw_error_t
shiva_rate_add_byte_set(a_uint32_t dev_id, fal_port_t port_id,
                         a_uint32_t size)
{
    sw_error_t rv;

    HSL_API_LOCK;
    rv = _shiva_rate_add_byte_set(dev_id, port_id, size);
    HSL_API_UNLOCK;
    return rv;
}
