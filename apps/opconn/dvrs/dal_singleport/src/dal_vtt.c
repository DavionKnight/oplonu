...
{
	UINT32 ponPortpvid = OPL_ZERO;
	UINT32 gePortPvid   = OPL_ZERO;
  ...
  //printf("dalVttModeSet:mode=%d,portId=%d\n", mode, portId);
...
{
  printf("Cls mask table:\n");
  dalClsMaskEntryShow(0,0,23,2);
  printf("Cls addr table:\n");
  dalClsAddrEntryShow(0,0,127,2);
  printf("Cls rule table:\n");
