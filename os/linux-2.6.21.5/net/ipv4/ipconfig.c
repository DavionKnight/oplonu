/*
 *  $Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/net/ipv4/ipconfig.c#1 $
 *
 ...
 */
#define OPL_DMA0_ETH_VI //add by zgd for eth1
...
DMA0LOOP:
  ...
  {
    ic_dev = ic_dev->next;
    ic_myaddr = 0x00000000;
    //ic_gateway = 0x01010101;
    goto DMA0LOOP;
  }
#endif
	return 0;
