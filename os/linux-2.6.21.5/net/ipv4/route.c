 ...
 *
 * Version:	$Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/net/ipv4/route.c#1 $
 *
 * Authors:	Ross Biro
...
ATOMIC_NOTIFIER_HEAD(rt_cache_flush_chain);
EXPORT_SYMBOL(rt_cache_flush_chain);
...
static void rt_run_flush(unsigned long dummy)
{
	...
	atomic_notifier_call_chain(&rt_cache_flush_chain, 0, NULL);
}
