...
#define CFG_NUM  3  /*3 cfg partition for transwitch*/
...
static struct mtd_partition flash_partitions[] = {
	{
		...
		.name =		"CFG 2",
		.size =		CFG_SIZE,
		.offset =	U_BOOT_SIZE +U_BOOT_ENV + CFG_SIZE+CFG_SIZE,
	},{
		.name =		"OS 0",
		.size =		OS_SIZE,
		.offset =	U_BOOT_SIZE +U_BOOT_ENV + CFG_SIZE+CFG_SIZE+CFG_SIZE,
	},{
		.name =		"OS 1",
		.size =		OS_SIZE,
		.offset =	U_BOOT_SIZE +U_BOOT_ENV + CFG_SIZE+CFG_SIZE+CFG_SIZE+OS_SIZE,
	},
