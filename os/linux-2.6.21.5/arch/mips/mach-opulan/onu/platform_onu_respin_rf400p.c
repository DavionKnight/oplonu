...
static struct mtd_partition respin_f23p_flash_partitions[] = {
	{
		.name = "Config",
		.size = OS_CFG,
...
static struct flash_platform_data respin_f23p_flash_data = {

	.map_name	= "cfi_probe",
	.name = "onu respin f23p flash",
	.parts		= respin_f23p_flash_partitions,
	.nr_parts	= ARRAY_SIZE(respin_f23p_flash_partitions),
	.width = 1,

};

static struct platform_device respin_f23p_flash_device = {

	.name		= "Opulan-flash",
	.id		= 0,
	.dev = {
		.platform_data = &respin_f23p_flash_data,
	},
