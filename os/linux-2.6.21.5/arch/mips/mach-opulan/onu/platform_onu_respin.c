...
static struct mtd_partition respin_flash_partitions[] = {
	{
		.name = "Config",
		.size = OS_CFG,
...
static struct flash_platform_data respin_flash_data = {

	.map_name	= "cfi_probe",
	.name = "onu respin flash",
	.parts		= respin_flash_partitions,
	.nr_parts	= ARRAY_SIZE(respin_flash_partitions),
	.width = 1,

};

static struct platform_device respin_flash_device = {

	.name		= "Opulan-flash",
	.id		= 0,
	.dev = {
		.platform_data = &respin_flash_data,
	},
