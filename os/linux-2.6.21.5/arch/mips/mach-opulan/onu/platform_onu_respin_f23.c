...
static struct mtd_partition respin_f13_flash_partitions[] = {
	{
		.name = "Config",
		.size = OS_CFG,
...
static struct flash_platform_data respin_spi_flash_data = {

	.name	= "respin_f13_spi_flash",
	.parts		= respin_f13_flash_partitions,
	.nr_parts	= ARRAY_SIZE(respin_f13_flash_partitions),
	.type = "mx25l160",

};

static struct platform_device respin_f13_flash_device = {

	.name		= "Opulan-flash",
	.id		= 0,
	.dev = {
		.platform_data = &respin_spi_flash_data,
	},
