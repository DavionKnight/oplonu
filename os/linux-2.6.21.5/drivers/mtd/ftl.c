 ...
 * $Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/mtd/ftl.c#1 $
 *
...
{
	DEBUG(0, "$Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/mtd/ftl.c#1 $\n");
