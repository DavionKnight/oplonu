/* $Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/scsi/aha1542.c#1 $
...
/*
   static const char RCSid[] = "$Header: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/scsi/aha1542.c#1 $";
 */
