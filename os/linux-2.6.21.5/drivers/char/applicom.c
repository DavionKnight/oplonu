...
/* $Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/char/applicom.c#1 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/char/applicom.c#1 $\n");
