 ...
 *  more details.
 *
 *  $Header: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/video/pm3fb.c#1 $
 *
 *  CHANGELOG:
...
int __init pm3fb_init(void)
{
	...
	DPRINTK(2, "This is pm3fb.c, CVS version: $Header: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/video/pm3fb.c#1 $");
