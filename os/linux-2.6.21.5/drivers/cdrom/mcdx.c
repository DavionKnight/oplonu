...
static const char *mcdx_c_version
    = "$Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/cdrom/mcdx.c#1 $";
#endif
...
static int __init mcdx_init(void)
{
	...
	xwarn("$Id: //depot/sw/abu/opconn/release/v3.2.1/os/linux-2.6.21.5/drivers/cdrom/mcdx.c#1 $\n");
