...
#if defined(CONFIG_ONU_F13P_VOIP_PCM_WDT_BOARD)||defined(CONFIG_ONU_F33_VOIP_BOARD)
#define SYS_CLK ((((*(volatile u32 *)(0xBF000000))&0xF)==1)?131072000:125000000) 
#define CPU_CLK ((((*(volatile u32 *)(0xBF000000))&0xF)==1)?212992000:300000000) 
#else
#define SYS_CLK 125000000
#define CPU_CLK ((((*(volatile u32 *)(0xBF000000))&0xF)==1)?203125000:200000000) 
#endif


#ifdef CONFIG_ONU_RESPIN_BOARD
#undef CPU_CLK
#define CPU_CLK 50000000
#endif

#ifdef CONFIG_ONU_RESPIN_C13_SPI_300M_BOARD
#undef CPU_CLK
#define CPU_CLK 300000000
#endif

#ifdef CONFIG_ONU_RESPIN_RF400_BOARD
#undef CPU_CLK
