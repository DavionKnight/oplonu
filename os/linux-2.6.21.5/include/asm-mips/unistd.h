...
#define __NR_test_waitinterrupt			(__NR_Linux + 316)
#define __NR_test_getdata			(__NR_Linux + 317)
#define __NR_test_setdata			(__NR_Linux + 318)
#define __NR_sys_mirror_data  (__NR_Linux + 319)
#define __NR_sys_voicevlan_data  (__NR_Linux + 320)
