...
#define CFI_FLASH_SHIFT_WIDTH   3
/* Prototypes */
flash_info_t    flash_info[CFG_MAX_FLASH_BANKS]; /* info for FLASH chips    */  /*zw change*/
...
#define AMD_ID_GL32M    0x227E227E  /* ??? S29GL256 ID (64 M, dual boot sectors)*/
...
#define SST_ID_39VF160  0x27822782
#define MX_ID_LV640EB   0x22CB22CB   /**/
#define MX_ID_256EH       0x227E227E
...
#define MXIC_ID_MX29LV640D  0x22CB22CB          /*zw add*/  /*BOTTOM*/
#define MXIC_ID_KH29LV640D 0x22c922c9        /*zw add*/ 
#define EON_ID_EN29LV640_B  0x22cb22cb          /*zw add*/  /*BOTTOM*/
#define EON_ID_EN29LV640_T  0x22c922c9          /*zw add*/  /*TOP*/
#define SPAN_ID_S29GL_64    0X007E007E            /*zw  add*/
#define STM_ID_M29W640GB  0x227E227E           /*zw add*//*bottom*/
/*-----------------------------------------------------------------------
...
#define FLASH_MXLV640EB 0x00AD
#define FLASH_MX256EH    0x00AE
...
#define FLASH_AM29GL256P 0x00F1      /* AMD Am29F256GL  (  32M =128K * 256 )      */
#define FLASH_AM29GL64M 0x00F2        /*zw add*/

#define FLASH_MX29LV640D  0x00CB                /*MXIC MX29LV640D (64MBIT 16M*4)*/ /*zw*/
#define FLASH_EN29LV640    0x00CB                /*EON EN29LV640D (64MBIT 16M*4)*/ /*zw*/
#define FLASH_S29GL64      0X007E     /*zw*/
#define FLASH_EN29LV640_B  0X00CB   /*zw*/
#define FLASH_KH29LV640_B  0X22C9 
#define FLASH_M29W640GB 0X007E      /*zw*/
...
#define FLASH_MAN_EON  0X00600000  /*zw add*/
