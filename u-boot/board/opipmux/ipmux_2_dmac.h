...
#define OP_IPMUX_GEL_ADDR   0xbf003430    
#define OP_IPMUX2_DMA_ADDR   0xbf014000     /* zw */
#define MSG_CFG_RGS   0xbf028098
#else
...
typedef struct TBL_ACC_DATA   /**BD format**/
{
    volatile UINT32  acc_data0;       
    volatile UINT32  acc_data1; 
} tbl_acc_data;


typedef struct gmac_ctrl_registers
{
    volatile UINT32  sta_addr0;        /* 0x00 */
    volatile UINT32  sta_addr1;        /* 0x04 */
    volatile UINT32  reserved2[2];     /* 0x08-0x0c */
} gmac_ctrl_reg;
#else
typedef struct gmac_ctrl_registers
{
...
typedef struct PKT_HEADER_ATHEROS_t
{
    /* begin modified by jiangmingli for new atheros packet head struct */
    /* atheros 8306 header struct */
    #if 0
    #ifdef BIGENDIAN
    UINT16 usVersionHi:2;
    UINT16 usPriority:2;
    UINT16 usPackType:4;
    UINT16 usBroadcast:1;
    UINT16 usFromCpu:1;
    UINT16 usVersionLo:2;
    UINT16 usPortNum:4;
    #else
    UINT16 usPortNum:4;
    UINT16 usVersionLo:2;
...
{  
    volatile UINT32  DMAI_STA_R;
    volatile UINT32  RES[3];
    volatile UINT32  DMAI_EN_R;
    volatile UINT32  RES1[3];
    volatile UINT32  DMAI_MA_R;
    volatile UINT32  RES2[3];
    volatile UINT32  DMAC_TBL_ACC_CTRL;        
    volatile UINT32  RES3;
    volatile UINT32  DMAC_TBL_ACC_DATA_0;
    volatile UINT32  DMAC_TBL_ACC_DATA_1;         
    volatile UINT32  RES4[15]; 
    volatile UINT32  DMAC_INIT;
    volatile UINT32  BASEADDR;              /*buffer base address*/
    volatile UINT32  DMAC_MSG_CFG;
    volatile UINT32  DMAC_PCIE_CFG;
    volatile UINT32  DMAC_TF_CFG;
    volatile UINT32  DMAC_MSG_POINT;
    volatile UINT32  DMAC_PCIE_POINT;
    volatile UINT32  DMAC_TF_POINT;
    volatile UINT32  RES5[9];
    volatile UINT32  DMAC_MSG_MTU;          /*OFFSET 0X30*/
    volatile UINT32  DMAC_MSGRD_HOLD;
    volatile UINT32	DMAC_PCIERD_HOLD;
    volatile UINT32  DMAC_TFRD_HOLD;
    volatile UINT32  RES6[12];
    volatile UINT32  DMAC_SCH_MODE;
  //  volatile UINT32  RES7[31];
  //  volatile UINT32  DMAC_MSGR_CNT;
  //  volatile UINT32
...
typedef struct gmac_dmal_registers
{
    ...
    volatile UINT32  BDINT;                 /*Buffer DMA interrupt*/
    volatile UINT32  BDIE;                  /*Buffer DMA interrupt enable*/
    volatile UINT32  PCK_DROP_THRESHOLD;    /*Packet Drop Threshold Register*/
