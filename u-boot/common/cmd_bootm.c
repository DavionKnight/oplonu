...
#define DEBUG 1
/*#define debug(fmt,args...)	printf (fmt ,##args) cut by wwei warning: "debug" redefined*/
 /*cmd_boot.c*/
 extern int do_reset (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[]);
 extern void opipmux_gel_reset(void);
...
//#endif
	...
	printf("do_bootm()................\n");
       printf("Disable FE port\n");
	opipmux_gel_reset();//disable fe   /*kxu*/
...
# error Unknown CPU type
	...
	case IH_COMP_NONE:
		...
		break;
	case IH_COMP_GZIP:
		printf ("   Uncompressing (gzip) %s ... ", name);
		//printf("load address:%x\n",ntohl(hdr->ih_load));
		if (gunzip ((void *)ntohl(hdr->ih_load), unc_len,
		//if (gunzip ((void *)0x80100000, unc_len,
			    (uchar *)data, &len) != 0) {
...
#ifdef CONFIG_BZIP2
	case IH_COMP_BZIP2:
		printf ("   Uncompressing (gzip2) %s ... ", name);
		/*
	...
	printf("compressing finished ...type %d..............\n",hdr->ih_type);
		...
		int	verify)
{
	...
	*kbd = *(gd->bd);
	...
	if (data) {
		...
		printf ("   initrd_start %08lx, end %08lx ... ",
	 ...
	 */
	printf ("   initrd_start %08lx end %08lx ;cmd_start =%x cmd_end=%x... ",
