...
printf ("addr---------------- 0x%08lx ...\n", addr);
    ...
    #if defined(CONFIG_IPMUX_E) || defined(CONFIG_IPMUX_E_MPW) || defined(CONFIG_IPMUX_CLT)  || defined(CONFIG_IPMUX_E2)
...
#if 1
        sprintf (build_buf, 
          "lnPci(0,0) h=192.168.1.58 u=target pw=target");
...
/*
        ...
        sprintf(&build_buf[strlen (build_buf - 1)],"u=target ");
        sprintf(&build_buf[strlen (build_buf - 1)],"pw=target");
*/
