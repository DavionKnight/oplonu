...
#endif
extern int ipmux_eth_initialize(bd_t *);
extern int opipmux_gmac_initialize(bd_t*);
...
int eth_initialize(bd_t *bis)
{
	...
	eth_devices = NULL;
	eth_current = NULL;
#ifdef CONFIG_OPIPMUX_GMAC
	opipmux_gmac_initialize(bis);
#endif
#ifdef IPMUX_E2_ETH_GE
	ipmux_eth_initialize(bis);
#endif
...
#ifndef CONFIG_OP_IPMUX
	/* don't make the gmac always reset */	
